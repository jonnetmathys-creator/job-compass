...
test('injecte le code ROME diététique', () => {
  const p = buildSearchParams({ intitule: 'Diététicienne Nantes', mots_cles: [], localisation: '44109', rayon_km: 30, type_contrat: 'CDI' })
...
test('fusionne les mots-clés de la recherche avec ceux par défaut, sans doublon', () => {
  const p = buildSearchParams({ intitule: 'Diététicienne Nantes', mots_cles: ['nutrition', 'libéral'], localisation: '44109', rayon_km: 30, type_contrat: null })
